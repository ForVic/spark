...
private[spark] class ExecutorAllocationManagerWithDrp(
  ...
  extends Logging with ExecutorAllocationManagerShared {
  ...
  override private[spark] val numExecutorsToAddPerResourceProfileId =
  ...
  override private[spark] val numExecutorsTargetPerResourceProfileId =
    new mutable.HashMap[Int, Int]
   ...
   */
  override private[spark] def maxNumExecutorsNeededPerResourceProfile(rpId: Int): Int = {
